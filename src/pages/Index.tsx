...
const Index = () => {
  ...
  return (
    <div className="h-screen overflow-hidden" style={backgroundStyle}>
      ...
      {/* Main Layout - Split into 2 sections */}
      <div className="h-full flex">
        {/* Main Content Area - 75% */}
        <div className="flex-1 flex flex-col" style={{ flex: '0 0 75%' }}>
          {/* Settings Button - Top Right of main area */}
          <div className="absolute top-6 right-6 z-10 flex gap-2" style={{ right: '25%' }}>
            <Button 
              size="sm" 
          ...
          {/* Red Border Box Content */}
          <div className="flex-1 flex flex-col items-center justify-center p-8 border-4 border-red-500 m-4 rounded-lg">
        ...
        {/* Winners List Sidebar - 25% */}
        <div className="bg-white/90 backdrop-blur-sm border-l border-gray-200 flex flex-col" style={{ flex: '0 0 25%' }}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="absolute -top-2 -right-2 w-6 h-6 bg-red-500 hover:bg-red-600 text-white rounded-full flex items-center justify-center shadow-lg transition-all duration-200 opacity-0 group-hover:opacity-100 z-20"
